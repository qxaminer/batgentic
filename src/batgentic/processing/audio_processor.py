...
if AUDIO_LIBS_AVAILABLE:
    ...
    # Dummy class for when audio libraries are not available
    class AudioProcessor:
        """
        Dummy AudioProcessor for when audio libraries are not available.
        This allows the module to import without errors in demo mode.
        """
        ...
        def process_single_file(self, *args, **kwargs):
            raise ImportError("Audio processing not available in demo mode")
